...
// merged set of all ignore patterns across every language
// plus universal baseline ignores that always apply
export const ALL_IGNORES = new Set([
  '.git', 'codebase-out', '.env', '.agent', '.agents',
]);
